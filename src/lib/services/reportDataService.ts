/**
 * Report Data Service - Lab 2 eGovernment 2025
 * 
 * This service provides data aggregation functions for the PDF reporting system.
 * It fetches payments from the database and computes various statistics.
 */
